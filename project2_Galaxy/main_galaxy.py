...
class MainWidget(RelativeLayout):
    ...
    #竖线
    V_NB_LINES = 10
    V_LINE_SPACING = .3 # width百分比
    vertical_line = []

    #横线
    H_NB_LINES = 15
    H_LINE_SPACING = .25 # height百分比
    horizontal_line = []
    ...
    def update_ship(self):
        ...
        self.ship_coordinates = [(center_x - ship_half_width, base_y), (center_x, base_y + ship_height), (center_x + ship_half_width, base_y)]
    ...
    def generate_tiles_coorinates(self):
        last_x = 0
        last_y = 0
        # 清理不在屏幕内的tiels
        ...
        if(len(self.tiles_coordinates) > 0):
            last_corrdinates = self.tiles_coordinates[-1]
            last_x = last_corrdinates[0]
            last_y = last_corrdinates[1] + 1
        print("foo1")
    ...
    def update_vertical_lines(self):
        ...
        for i in range(start_index, start_index + self.V_NB_LINES + 1):
